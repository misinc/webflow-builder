...
const BUNDLE_VERSION = "2026-07-14e · source URL + Style Guide done now remembered per Webflow site; copy shows Copied ✓; Sections grouped Built/To-build with checkmarks";
